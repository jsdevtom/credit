import {ImmutableOpWithActor, Op, OpWithActor} from '../src/op';
import {Change, ChangeImmutable} from '../src/change.interface';
import {UUID} from '../src/uuid';
import {Clock, ClockImmutable} from '../src/clock.interface';
import {OpAction} from '../src/op-action.type';
...
// TODO-Tom: convert me in to typescript
//{
//   "_init": {
//     "action": "makeList",
//     "obj": "01aeda4a-5118-4124-83f6-6b319ead5b32",
//     "actor": "db0fdfa3-0c93-4638-82a1-f7587c7f4bf4",
//     "seq": 1
//   },
//   "_inbound": [
//     {
...
//       "key": "fish",
//       "value": "01aeda4a-5118-4124-83f6-6b319ead5b32",
//       "actor": "db0fdfa3-0c93-4638-82a1-f7587c7f4bf4",
//       "seq": 1
//     }
//   ],
//   "_keys": {
//     "db0fdfa3-0c93-4638-82a1-f7587c7f4bf4:1": [
//       {
//         "action": "set",
//         "obj": "01aeda4a-5118-4124-83f6-6b319ead5b32",
//         "key": "db0fdfa3-0c93-4638-82a1-f7587c7f4bf4:1",
//         "value": "trout",
//         "actor": "db0fdfa3-0c93-4638-82a1-f7587c7f4bf4",
//         "seq": 1
//       }
//     ],
//     "db0fdfa3-0c93-4638-82a1-f7587c7f4bf4:2": [
//       {
//         "action": "set",
//         "obj": "01aeda4a-5118-4124-83f6-6b319ead5b32",
//         "key": "db0fdfa3-0c93-4638-82a1-f7587c7f4bf4:2",
//         "value": "sea bass",
//         "actor": "db0fdfa3-0c93-4638-82a1-f7587c7f4bf4",
//         "seq": 1
//       }
...
//   }
// }
interface OpSetByObject extends Map<string, {
  _init: {
    action: OpAction,
    obj: UUID,
    actor: UUID,
...
export interface OpSet {
  'states': {
    [id: string]: [
      {
        change: Change,
        allDeps: { [id: string]: number, },
      },
    ],
  },
  undoStack: Array<Array<Op>>,
  deps: Clock,
  undoLocal: Array<Op>,
  redoStack: [],
  clock: Clock,
  ...
  byObject: OpSetByObject,
}

export interface ImmutableOpSet extends Map<keyof OpSet, OpSet[keyof OpSet]> {
}
...
function isConcurrent(opSet: ImmutableOpSet, op1: ImmutableOpWithActor, op2: ImmutableOpWithActor): boolean {
  ...
  const clock1: ClockImmutable = opSet.getIn(['states', actor1, seq1 - 1, 'allDeps']);
  const clock2: ClockImmutable = opSet.getIn(['states', actor2, seq2 - 1, 'allDeps']);
...
function causallyReady(opSet: ImmutableOpSet, change: ChangeImmutable): boolean {
  const actor = change.get('actor') as Change['actor'];
  const seq = change.get('seq') as Change['seq'];
  let satisfied = true;
  (change.get('deps') as Change['deps']).set(actor, seq - 1).forEach((depSeq, depActor) => {
